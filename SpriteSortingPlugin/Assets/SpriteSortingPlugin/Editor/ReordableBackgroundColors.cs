...
namespace SpriteSortingPlugin
{
    public static class ReordableBackgroundColors
    {
        ...
        public static readonly Color ActiveColor = new Color(0.1f, 0.69f, 1f, 0.7f);
        public static readonly Color FocussingColor = new Color(0.45f, 0.77f, 0.95f, 0.91f);
        public static readonly Color TransparentBackgroundColor = new Color(0.76f, 0.76f, 0.76f, 0.5f);
    }
}